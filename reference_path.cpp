...
bool ReferencePath::buildReferenceFromStates(const std::vector<State> &states) {
...
void ReferencePath::setSpline(const tk::spline &x_s,
                              const tk::spline &y_s,
                              double max_s) {
    reference_path_impl_->setSpline(x_s, y_s, max_s);
}

void ReferencePath::setOriginalSpline(const tk::spline &x_s,
                                      const tk::spline &y_s,
                                      double max_s) {
